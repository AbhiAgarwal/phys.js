...
suvat.solve = function(){
	...
	if((equation.s == null) && (equation.u == null) && (equation.v == null)
		&& (equation.a == null) && (equation.t == null)){
		console.log("Library hasn't been initialized - use suvat.create(...)");
		return null;
	}
	// SUVATuta, finding u, t, a
	// returns displacement
	else if((equation.u != null) && (equation.t != null) && (equation.a != null)){
		return(mechanics.SUVATuta(equation.u, equation.t, equation.a));
	}
	// SUVATuvt, finding u, v, t
	// returns displacement
	else if((equation.u != null) && (equation.v != null) && (equation.t != null)){
		return(mechanics.SUVATuvt(equation.u, equation.v, equation.t));
	}
	// SUVATvta, finding v, t, a
	// returns displacement
	else if((equation.v != null) && (equation.t != null) && (equation.a != null)){
		return(mechanics.SUVATvta(equation.v, equation.t, equation.a));
	}
	// SUVATuat, finding u, a, t
	// returns velocity
	else if((equation.u != null) && (equation.a != null) && (equation.t != null)){
		return(mechanics.SUVATuat(equation.u, equation.a, equation.t));
	}
	// SUVATuas, finding u, a, s
	// returns velocity^2, not velocity
	else if((equation.u != null) && (equation.a != null) && (equation.s != null)){
